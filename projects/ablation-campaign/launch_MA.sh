...
# launch_MA_llama32-1b-instruct_mn5.sh (the retired 125 h arm) and
# launch_MA_700_llama32-1b_mn5.sh (700 h arm), now:
#
...
export STAGE=MA
export CONFIG="${CONFIG:-${SCRIPT_DIR}/ABL-MA-700-asr.yaml}"
